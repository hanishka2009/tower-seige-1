...
function setup(){
   ...
   b6=new Box(320,600,50,50)
   b7=new Box(372,600,50,50)
   b8=new Box(422,600,50,50)
   b9=new Box(472,600,50,50)
   b10=new Box(350,500,50,50)

   b11=new Box(400,500,50,50)
   b12=new Box(450,500,50,50)
   b13=new Box(374,440,50,50)
   b14=new Box(424,440,50,50)
   b15=new Box(400,395,50,50)
